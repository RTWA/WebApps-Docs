                ...
                ctx => (
                    <>
                        <div className="w-full flex flex-row justify-center">
                            <Button color={ctx.UI.theme} className="mx-auto mb-8">A default Button</Button>
                            <Button color={ctx.UI.theme} className="mx-auto mb-8" square>A square Button</Button>
                            <Button color={ctx.UI.theme} className="mx-auto mb-8" rounded>A rounded Button</Button>
                        </div>
                        <div className="w-full flex flex-row justify-center">
                            <Button color={ctx.UI.theme} className="mx-auto mb-8" style="outline">An outline Button</Button>
                            <Button color={ctx.UI.theme} className="mx-auto mb-8" style="ghost">A ghost Button</Button>
                            <Button color={ctx.UI.theme} className="mx-auto mb-8" style="link">A link Button</Button>
                        </div>
                        <div className="w-full flex flex-row justify-center">
                            <div className="mx-auto"><Button color={ctx.UI.theme} size="small">A small Button</Button></div>
                            <Button color={ctx.UI.theme} className="mx-auto" size="large">A large Button</Button>
                        </div>
                    </>
                )
            }
