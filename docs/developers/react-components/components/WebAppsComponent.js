...
// This need improving - workaround to get tailwind into Docusaurus
import './WebApps.css';

const WebAppsComponent = ({ UI, setUI, children, withColors, noDarkSwitch }) => {
...
export default withWebAppsDocs(WebAppsComponent);